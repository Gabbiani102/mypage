...
- 이후 모듈(축평원 이력연동, 미트와치 연동, MRP 연동 등)이 참조할 기준 데이터 정의
    ...
    "category": "Industries",
    "license": "LGPL-3",
    "depends": ["base", "sale", "stock", "product", "account", "hr"],
    "data": [
        ...
        "data/livestock_classification_code_data.xml",
        "data/livestock_cut_data.xml",
        "data/product_account_data.xml",
        "data/livestock_uom_data.xml",
        "views/livestock_species_views.xml",
        "views/livestock_grade_views.xml",
        "views/livestock_cut_views.xml",
        "views/common_code_views.xml",
        "views/product_account_views.xml",
        "views/livestock_uom_views.xml",
        "views/res_partner_views.xml",
        "views/res_partner_registration_views.xml",
        "views/product_template_views.xml",
        "views/product_template_registration_views.xml",
